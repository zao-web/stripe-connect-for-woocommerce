<?php
/**
 * Stripe_Connect_For_WooCommerce Test Bootstrapper.
 *
 * @since   0.1.0
 ...
 * @since 0.1.0
 */
function _manually_load_stripe_connect_for_woocommerce_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/stripe-connect-for-woocommerce.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_stripe_connect_for_woocommerce_plugin' );
